...
We need to determine which items to put in the package so that the total cost of the items you put inside is as large as possible. In case the total cost the of the packaged items is the same for two sets of items, we will prefer the combination of items which has a lower total weight.
